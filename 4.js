...
class Portfolio {
  ...
  // Зробіть метод readElements, який читає інформацію про всі об'єкти в портфоліо в залежності від того,
  //... якого класу елемент викликає readLetter, readPicture, readMovie
